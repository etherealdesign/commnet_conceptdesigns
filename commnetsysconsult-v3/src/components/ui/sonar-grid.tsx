/*
 * Adapted for this codebase (Vite + React 19, not Next.js):
 *  - the original's "use client" directive is dropped; Vite has no RSC boundary
 *    and Rollup emits a "module level directives cause errors when bundled"
 *    warning for it on every build.
 * Everything else is the component as published.
 */
