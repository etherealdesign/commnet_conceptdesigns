...
export type SystemCode = 'A1' | 'A2' | 'A3' | 'A4' | 'A5' | 'A6'
...
export const projects: Project[] = [
  ...
  { slug: 'dewa-csoc', name: 'DEWA Cyber Security Operations Centre', clientOfRecord: 'DEWA', prime: 'GBM', location: 'Dubai, UAE', duration: '1 year', sector: 'Government', environment: 'Command, Control & Security Centres', environmentSlug: 'command-security-centres', systems: ['A1', 'A2', 'A3', 'A6'], quantities: 'Rack & panel cabling, device T&C', facts: ['Rack and panel cabling', 'Device testing and commissioning', 'Utility command-and-control standard'], scope: 'Physical build-out of a utility command-and-control room: racks, panel cabling, device installation, testing and commissioning.' },
