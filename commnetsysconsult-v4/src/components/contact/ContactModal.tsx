    ...
    >
      <div className="flex h-full items-end justify-center md:items-center">
        <div
          ref={panel}
          data-lenis-prevent
          className="relative flex max-h-[92dvh] w-full flex-col overflow-y-auto bg-cream md:max-h-[88dvh] md:w-[min(920px,calc(100vw-48px))]"
        >
          <div className="sticky top-0 z-10 flex items-center justify-between border-b border-ink/10 bg-cream px-5 py-4 md:px-8">
            <h2 className="text-16 font-medium">Get in contact</h2>
            <button
              type="button"
              className="cursor-pointer text-14 text-grey transition-colors hover:text-ink"
          ...
          <div className="grid gap-10 px-5 py-8 md:grid-cols-[1fr_1.6fr] md:px-8 md:py-10">
            <div className="flex flex-col gap-6">
              <p className="d-3">Send us the drawings. <em>An engineer replies.</em></p>
              <ul className="flex flex-col gap-5 text-14 text-grey">
                {site.offices.map((o) => (
                  <li key={o.id}>
