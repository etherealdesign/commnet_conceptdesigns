...
export function Faq({ items = faqItems, heading = 'Common questions' }: { items?: FaqItem[]; heading?: string }) {
  ...
  return (
    <Block ref={ref} anchor="faq" isDark className="theme-dark py-24 md:py-32">
      <div className="grid-container">
        <div className="grid-layout gap-y-12">
          <h2 data-reveal className="t-h2 grid-span-12 lg:grid-span-4 max-w-[8ch]">
            {heading}
          </h2>
          <ul data-reveal className="grid-span-12 lg:grid-span-6 lg:grid-start-6 border-t border-line">
            {items.map((item, i) => (
